#pragma checksum "C:\Users\jpola\source\repos\Jepolancodlc\FE-ProyectoFinal\FRONT_Proyecto_Team1_AJV\FRONT_Proyecto_Team1_AJV\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dc4e51118fbbcd59ba37562f1de4fea433ef3d9f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dc4e51118fbbcd59ba37562f1de4fea433ef3d9f", @"/Views/Home/Index.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "dc4e51118fbbcd59ba37562f1de4fea433ef3d9f5054", async() => {
            }
            );
    ...
    <div class=""row vh-100"">
     ");
        ...
        <div class=""col-2"" id=""colMenuFiltros"">
            ...
            WriteLiteral(@"'#containerScreen')"" class=""bi bi-graph-up btnMenu""></i>
                    </button>

                    <button id=""btnDepartamentos"" class=""input-group rounded btnOrganizativa"">
                        <i class=""btnMenu"" onclick=""PrintarTabla('#containerScreen');"">Financias</i>
                        <i onclick=""getKendoCharts('#containerScreen')"" class=""bi bi-graph-up btnMenu""></i>
                    </button>

                    <button id=""btnDepartamentos"" class=""input-group rounded btnOrganizativa"">
                        <i class=""btnMenu"" onclick=""PrintarTabla('#containerScreen');"">Marketing</i>
                        <i onclick=""getKendoCharts('#containerScreen')"" class=""bi bi-graph-up btnMenu""></i>
                    </button>

                    <button id=""btnDepartamentos"" class=""input-group rounded btnOrganizativa"">
                        <i class=""btnMenu"" onclick=""PrintarTabla('#containerScreen');"">RRHH</i>
                        <i onclick=""getKendoCharts('#contain");
            WriteLiteral(@"erScreen')"" class=""bi bi-graph-up btnMenu""></i>
                    </button>

                    <button id=""btnDepartamentos"" class=""input-group rounded btnOrganizativa"">
                        <i class=""btnMenu"" onclick=""PrintarTabla('#containerScreen');"">I+D</i>
                        <i onclick=""getKendoCharts('#containerScreen')"" class=""bi bi-graph-up btnMenu""></i>
                    </button>

                    <button id=""btnDepartamentos"" class=""input-group rounded btnOrganizativa"">
                        <i class=""btnMenu"" onclick=""PrintarTabla('#containerScreen');"">I+A</i>
                        <i onclick=""getKendoCharts('#containerScreen')"" class=""bi bi-graph-up btnMenu""></i>
                    </button>
                </div>
