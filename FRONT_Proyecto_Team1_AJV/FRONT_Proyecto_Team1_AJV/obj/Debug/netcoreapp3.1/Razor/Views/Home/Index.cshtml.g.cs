#pragma checksum "C:\Users\jpola\source\repos\Jepolancodlc\FE-ProyectoFinal\FRONT_Proyecto_Team1_AJV\FRONT_Proyecto_Team1_AJV\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "43d547044b282e4bd055a6b937db1c094bff9295"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"43d547044b282e4bd055a6b937db1c094bff9295", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\jpola\source\repos\Jepolancodlc\FE-ProyectoFinal\FRONT_Proyecto_Team1_AJV\FRONT_Proyecto_Team1_AJV\Views\Home\Index.cshtml"
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("img", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "43d547044b282e4bd055a6b937db1c094bff92955120", async() => {
            }
            );
    ...
    <div class=""col-sm col2"">
            ...
            <div class=""col colhor "">
                ...
                <div id=""secbtn"">
                    ...
                    <button class=""btnDis"" disabled>
                        <i class=""bi bi-diag");
            WriteLiteral(@"ram-3-fill""></i> Grupo Castilla (No
                        tocar)
                    </button>
                </div>
            </div>
        ...
        <div class=""row vh-100"">
            ...
            WriteLiteral(@" rounded btnOrganizativa"">
                        <i fill=""#005ab7"" class=""bi bi-building btnMenu""></i>
                        <i class=""btnMenu"" onclick=""PrintarTabla('#containerScreen');"">Ayuntamiento</i>
                        <i onclick=""getKendoCharts('#containerScreen')"" class=""bi bi-graph-up btnMenuGraph""></i>
                    </button>
                    <div id=""grupoBoton"">
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                         ");
            WriteLiteral(@"   <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Administratiu/iva');"">Administratiu/iva</i>
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                          ...
                          ");
            WriteLiteral(@"  <i onclick=""getKendoChartsID('#containerScreen', 'Assessor')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            ...
                            <i onclick=""getKendoChartsID('#containerScreen', 'Àrea ");
            WriteLiteral(@"de territori, via pública i mobilitat')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            ...
                            <i onclick=""getKendoChartsID('#containerScreen', 'Are");
            WriteLiteral(@"a de benestar Social')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Àrea de cultura Educació i Lleure');"">Àrea de cultura Educació i Lleure</i>
                            <i onclick=""getKendoChartsID('#containerScreen', 'Àrea de cultura Educació i Lleure')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Àrea de urbanisme i Habitatge');"">Àrea de urbanisme i Habitatge</i>
                            <i onclick=""getKendoChartsID('#containerScreen', 'Àrea de urb");
            WriteLiteral(@"anisme i Habitatge')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Àrea de comerç, turisme i ocupació');"">Àrea de comerç, turisme i ocupació</i>
                            <i onclick=""getKendoChartsID('#containerScreen', 'Àrea de comerç, turisme i ocupació')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Administratiu/va');"">Administratiu/va</i>
                            <i onclick=""getKendoChartsID('#containerScreen', 'Administratiu/va')"" class=""bi bi-gra");
            WriteLiteral(@"ph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            ...
                            <i onclick=""getKendoChartsID('#containerScreen', 'Urbanisme, Patrimoni i Centre Històric')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            ...
                            <i onclick=""getKendoChartsID('#containerScreen");
            WriteLiteral(@"', 'Sostenibilitat, Serveis Ambientals i Medi Natural')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Actuacions Públiques i Serveis');"">Actuacions Públiques i Serveis</i>
                            <i onclick=""getKendoChartsID('#containerScreen', 'Actuacions Públiques i Serveis')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Habitatge');"">Habitatge</i>
                            <i onclick=""getKendoChartsID('#containerScreen', 'Habitatge')"" class=""bi bi-g");
            WriteLiteral(@"raph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                        ...
                        <button class=");
            WriteLiteral(@"""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
            ...
            WriteLiteral(@"izativa"">
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            ...
                            <i onclick=""getKendoChartsID('#containerScreen', 'Ensenyament i Politica Lingüistica')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""b");
            WriteLiteral(@"i bi-inboxes btnMenu""></i>
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            ...
                            <i onclick=""getKendoChartsID('#containerScreen', 'Acció Comunitària, Participació i Igualtat')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""><");
            WriteLiteral(@"/i>
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""G");
            WriteLiteral(@"etTablaID('#containerScreen', 'Governació');"">Governació</i>
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Transparéncia,Oficina d\'Atenci");
            WriteLiteral(@"ó al Ciutadà i Tecnologia de la Informació');"">Transparéncia,Oficina d'Atenció al Ciutadà i Tecnologia de la Informació</i>
            ...
            WriteLiteral(@"GetTablaID('#containerScreen', 'Interventor/a');"">Interventor/a</i>
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                            <i class=""btnMenu"" onclick=""GetTablaID('#containerScreen', 'Àrea de serveis econòmics');"">Àrea de serveis econòmics</i>
                          ");
            WriteLiteral(@"  <i onclick=""getKendoChartsID('#containerScreen', 'Àrea de serveis econòmics')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
                        ...
                        <button class=""input-group rounded btnOrganizativa"">
                            ...
                            <i onclick=""getKendoChartsID('#containerScreen', 'Educador/a social");
            WriteLiteral(@"')"" class=""bi bi-graph-up btnMenuGraph""></i>
                        </button>
                        <button class=""input-group rounded btnOrganizativa"">
                            <i fill=""#005ab7"" class=""bi bi-inboxes btnMenu""></i>
            ...
            <!-- Tabla -->
 ");
            WriteLiteral("           <div id=\"containerScreen\" class=\"col-10 colb containerScreen vh-100\"></div>\r\n        </div>\r\n    </div>\r\n    </div>");
        }
